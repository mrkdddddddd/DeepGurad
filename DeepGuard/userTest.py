...
class FaceRecognitionApp:
    def __init__(self, root):
        ...
        self.exit_button = tk.Button(root, text="Exit", command=self.on_closing, bg='#404040', fg='black', width=10, height=2, relief="raised", borderwidth=0, highlightthickness=0, highlightbackground='white')
        self.exit_button.config(bg="#D9D9D9", padx=20, border=5)
        self.exit_button.pack(pady=7)
